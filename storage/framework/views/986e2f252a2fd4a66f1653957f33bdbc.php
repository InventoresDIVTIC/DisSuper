      ...
      <div class="row justify-content-center">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="<?php echo e(route('indicadores.update', $indicador->id)); ?>" method="post">
              <?php echo csrf_field(); ?>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="clave_indicador" name="clave_indicador" maxlength="5" placeholder="Clave del Indicador" value="<?php echo e($indicador->Clave_Indicador); ?>">
                </div>

                <div class="form-group">
                  <label for="nombre_Empleado"><i class="fas fa-user"></i> Nombre:</label>
                  <input type="text" class="form-control" id="nombre_indicador" name="nombre_indicador" placeholder="Nombre del Indicador" value="<?php echo e($indicador->Nombre_Indicador); ?>">
                </div>

                <div class="form-group">
                  <label for="contrato_id"><i class="fas fa-file-contract"></i> Valor Mínimo Aceptable:</label>
                  <input type="number" max="100" min="0" class="form-control" id="valorMin_Indicador" name="valorMin_Indicador" placeholder="Valor Mínimo Aceptable en porcentaje de 0-100%" value="<?php echo e($indicador->Valor_Aceptable); ?>">
                </div>
...
<?php echo $__env->make('layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DisSuper\resources\views\indicadores\edit.blade.php ENDPATH**/ ?>