  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="<?php echo e(route('password.email')); ?>" method="post">
        <?php echo csrf_field(); ?> <!-- Agrega el token CSRF para protección -->
...
<!-- jQuery -->
<script src="<?php echo e(secure_asset('plugins/jquery/jquery.min.js')); ?>"></script>
<!-- Bootstrap 4 -->
...
</html><?php /**PATH C:\laragon\www\DisSuper\resources\views\auth\passwords\email.blade.php ENDPATH**/ ?>