      ...
      <div class="row justify-content-center">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="<?php echo e(route('empleado.update', $empleado->id)); ?>" method="post" id="form-empleado">
              <?php echo csrf_field(); ?>
              <?php echo method_field('PUT'); ?>
              <div class="card-body">
                <div class="form-group">
                  <label for="RPE_Empleado">RPE:</label>
                  <input type="text" class="form-control" id="RPE_Empleado" name="RPE_Empleado" value="<?php echo e(old('RPE_Empleado')?:$empleado->RPE_Empleado); ?>" placeholder="RPE">
                </div>
                <div class="form-group">
...
</html><?php /**PATH C:\laragon\www\DisSuper\resources\views\empleados\editA.blade.php ENDPATH**/ ?>