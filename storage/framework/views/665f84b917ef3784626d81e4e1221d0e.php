...
<body>
    ...
    <div class="datos_Documento">
        <b>
        Lugar, <?php echo e(now()); ?><br><br>
        Asunto:<br>
        Actividad Supervisada:<br>
        Fecha de Actividad:<br>
        Fecha de Supervision: <?php echo e($datosFormulario['Fecha_Supervision']); ?><br><br>
        </b>
...
</html><?php /**PATH C:\laragon\www\DisSuper\resources\views\pdf\copiaf.blade.php ENDPATH**/ ?>