        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if($empleado->RPE_Empleado !== auth()->user()->RPE_Empleado && $empleado->nombre_Empleado !== auth()->user()->name): ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($empleado->contrato->name); ?></td> <!-- Mostrar el tipo de contrato -->
