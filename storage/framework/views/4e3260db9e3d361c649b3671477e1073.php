...
<body>
    ...
    <div class="datos_Documento">
        <b>
        Lugar, <?php echo e(now()->format('d/F/Y')); ?><br><br>
        Asunto:<?php echo e($datosFormulario['Tipo_Documento']); ?><br>
        Actividad Supervisada:<br>
        Fecha de Actividad:<br>
        Fecha de Supervision: <?php echo e($datosFormulario['Fecha_Actividad']); ?><br><br>
        </b>
    ...
    <div class="datos_Empleado">
        <b>
        <?php echo e($empleado['nombre_Empleado']); ?><br>
        Auxiliar Comercial <br>
        R.T.T <?php echo e($empleado['RPE_Empleado']); ?><br>
    ...
    <div>
        ...
        Se realizó supervisión al ciclo <b>"Ciclo" Tarea <?php echo e($datosFormulario['Actividad']); ?></b> asignada al <b>C. <<?php echo e($empleado['nombre_Empleado']); ?></b>, R.P.E <b><?php echo e($empleado->RPE_Empleado); ?> </b>realizado el día 18  de Octubre del 2023.
        </p>
    </div>
...
</html><?php /**PATH C:\laragon\www\DisSuper\resources\views\pdf\formulario.blade.php ENDPATH**/ ?>