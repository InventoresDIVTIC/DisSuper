...
<head>
  ...
  <link href="<?php echo e(asset('ruta-a-tu-archivo-css/errors.css')); ?>" rel="stylesheet">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('dist/css/form_register.css')); ?>">
  <!-- CSS de SweetAlert -->
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex justify-content-center align-items-center flex-column">
          <div class="image profile-image-container">
              <?php if(Auth::check() && Auth::user()->photo): ?>
                  <img src="<?php echo e(asset(Auth::user()->photo)); ?>" alt="Foto de perfil" class="profile-image rounded-circle w-100" id="profileImage">
              <?php else: ?>
                  <img src="<?php echo e(asset('dist/img/D.png')); ?>" alt="Imagen predeterminada" class="profile-image rounded-circle w-100" id="profileImage">
              <?php endif; ?>
          </div>
