    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center">
                ...
                <form action="<?php echo e(route('actividades.store')); ?>" method="POST" class="form-inline">
                    <?php echo csrf_field(); ?>
        ...
        <tbody>
            <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="text-center"><?php echo e($actividad->id); ?></td>
                    <td class="text-center"><?php echo e($actividad->clave); ?></td>
                    <td class="text-center"><?php echo e($actividad->name); ?></td>
                    <td class="text-center">
                        <div class="btn-group">
                        <a href="<?php echo e(route('actividades.show', $actividad->id)); ?>" class="btn btn-primary btn-sm">
                            <i class="fas fa-eye"></i> Ver Indicadores
                        </a>
                            <form action="<?php echo e(route('actividades.destroy', $actividad->id)); ?>" method="POST" style="display: inline-block;">
...
<?php echo $__env->make('layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DisSuper\resources\views\actividades\index.blade.php ENDPATH**/ ?>