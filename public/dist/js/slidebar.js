$(document).ready(function() {
        ...
        <div class="indicador">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- El botón para agregar hallazgos dinámicamente -->
                    <button type="button" class="btn btn-info add-btn" id="addHallazgo">Agregar Hallazgo</button>
  ...
            </div>
        ...
        // Agregar el nuevo indicador al contenedor
        $("#hallazgos-container").append($nuevoHallazgo);
