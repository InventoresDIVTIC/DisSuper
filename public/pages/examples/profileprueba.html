...
<head>
  ...
  <title>David V Dashboard 2</title>
...
<div class="wrapper">
      ...
      <section class="content">
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-md-4">
                <h3>Hola, este es un listado de tus empleados</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-6 offset-md-3 text-center">
                ...
                <a href="/empleado/create">
                  <button class="btn btn-primary btn-block" type="button">Agregar Empleado</button>
                </a>
                </button>
              </div>
            </div>
              ...
              <?php
                ...
                if ($empleados->count() > 0) {
                  ...
                  foreach ($empleados as $empleado) {
                    ...
                    echo '<a href="/empleado/' . $empleado->id . '" type="button "class="btn btn-primary">Ver perfil</a>';
                    echo '<form action="/empleado/' . $empleado->id . '" method="POST" style="display: inline-block;">';
                    echo '<input type="hidden" name="_method" value="DELETE">';
                    echo '<input type="hidden" name="_token" value="' . csrf_token() . '">';
                    echo '<button class="btn btn-danger" type="submit" onclick="return confirm(\'¿Estás seguro de que deseas eliminar este empleado?\')">Eliminar</button>';
                    echo '</form>';
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 DisSuper</a>.</strong>
