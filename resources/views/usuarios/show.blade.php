                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item" style="width: 15%"><a class="nav-link active text-center" href="#InformacionGeneral"
                                        data-toggle="tab">Información General</a></li>
                                <li class="nav-item" style="width: 18%"><a class="nav-link text-center" href="#ListadoDocumentos"
                                        data-toggle="tab">Listado de Documentos</a></li>
                            ...
                            <div class="tab-pane" id="GenerarRC">
                                <form class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="string" class="form-control" id="inputIndicador"
