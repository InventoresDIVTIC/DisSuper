...
<body>
    <div class="container">
        ...
        <p>Lamentamos informarte que el documento con ID <strong>{{ $idDocumento }}</strong> que le corresponde al empleado <strong>{{ $Id_Empleado }}</strong>y que fue enviado a revisar a <strong>{{ $Id_Usuario_Revisar }}</strong> ha sido cancelado por <strong>{{ $Usercancelado }}</strong>.</p>
