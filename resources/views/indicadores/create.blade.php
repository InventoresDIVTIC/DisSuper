            ...
            <form action="{{ route('indicadores.store') }}" method="post" id="form-indicadores">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('clave_indicador'))
                      <span class="error-message">{{ $errors->first('clave_indicador') }}</span>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('nombre_indicador'))
                      <span class="error-message">{{ $errors->first('nombre_indicador') }}</span>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('valorMin_Indicador'))
                      <span class="error-message">{{ $errors->first('valorMin_Indicador') }}</span>
                  @endif
                </div>
